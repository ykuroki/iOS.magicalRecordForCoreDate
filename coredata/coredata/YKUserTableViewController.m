...
@interface YKUserTableViewController ()

@end

@implementation YKUserTableViewController
...
{
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"usetTableCell" forIndexPath:indexPath];
